    ...
    return ( 
      <div>
        <div style={{
          ...
          <div>
            <div className='container text-center p-3 p-sm-5 mt-3 mt-sm-5'>
                <div className='row'>
                    <div>
                        <h2 className='text-muted px-2' style={{
                            fontSize: 'clamp(1.3rem, 3vw, 1.9rem)',
                            lineHeight: '1.4'
                        }}>
                            We're revolutionizing business finance with AI intelligence.
                            <br className='d-none d-md-block' />
                            Making enterprise security accessible for all.
                        </h2>
                    </div>
                </div>
            </div>
            <div className='d-flex justify-content-center align-items-right'>
                <div className='row border-top p-3 p-sm-5 mt-3 mt-sm-5 fs-6 text-left text-muted' 
                    style={{
                        lineHeight: "1.8",
                    ...
                    <div className='col-12 col-md-6 p-4 '>
                        <p>Welcome to FinVerse, where we revolutionize financial management for small businesses through AI. Founded to democratize financial intelligence, we understand the challenges business owners face in managing their finances securely.</p>
                        <p>Our platform emerged from a simple idea: every business deserves access to sophisticated financial tools. By combining AI technology with user-friendly design, we've created a solution that protects your financial interests and empowers informed decisions.</p>
                        <p>What sets us apart is our commitment to security and education. Our ML-powered systems safeguard your transactions. We believe financial literacy is a right, not a privilege.</p>
                    </div>
                    <div className='col-12 col-md-6 p-4'>
                        <p>Our team of experts works continuously to evolve our platform, ensuring you have access to advanced tools for budgeting, forecasting, and business analysis. We measure our success by your growth, celebrating every milestone of our business partners.</p>
                        <p>Join thousands of successful business owners who have transformed their financial management with FinVerse. Together, we're building a future where financial success is accessible and achievable for every business.</p>
                    </div>
                </div>
            </div>
